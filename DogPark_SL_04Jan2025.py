...
def main():
    ...
    st.sidebar.write("When you're ready, click the 'Run Simulation' button beneath the slides to see the dog park come to life.")
    st.sidebar.markdown("**I hope you enjoy it :)**")

    # Sidebar controls for user input
    st.sidebar.header("Simulation Settings")
    grid_width = st.sidebar.slider("Width of the Dog Park:", 10, 15, 12)
    grid_height = st.sidebar.slider("Height of the Dog Park:", 10, 15, 12)
